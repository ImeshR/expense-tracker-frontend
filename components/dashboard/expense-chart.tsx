    ...
    return (
        <ResponsiveContainer width="100%" height={350}>
            <AreaChart data={chartData}>
                ...
                <XAxis dataKey="date" stroke="#888888" fontSize={12} tickLine={false} axisLine={false} tickMargin={8} />
                <YAxis
                    stroke="#888888"
                    fontSize={12}
                    tickLine={false}
                                ...
                                <div className="rounded-lg border bg-background p-2 shadow-md">
                                    <div className="grid grid-cols-2 gap-2">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span className="font-bold">LKR {payload[0]?.value?.toLocaleString()}</span>
                                        </div>
                                    </div>
                                </div>
                            )
